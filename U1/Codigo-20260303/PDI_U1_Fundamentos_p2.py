...
img = cv2.imread('Codigo-20260303/cameraman.tif',cv2.IMREAD_GRAYSCALE)
img.shape
...
# Python se maneja por referencia no por variable
...
img = cv2.imread('Codigo-20260303/letras.png',cv2.IMREAD_GRAYSCALE)
img.shape
